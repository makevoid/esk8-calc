...
Opal.modules["corelib/constants"] = function(Opal) {
  ...
  Opal.cdecl($scope, 'RUBY_ENGINE_VERSION', "0.10.1");
  Opal.cdecl($scope, 'RUBY_RELEASE_DATE', "2016-07-06");
...
Opal.modules["js"] = function(Opal) {
  ...
  return (function($base) {
    ...
    Opal.defn(self, '$global', TMP_2 = function ːglobal() {
      var self = this;
    ...
    Opal.defn(self, '$call', TMP_9 = function ːcall(func, $a_rest) {
...
Opal.modules["console"] = function(Opal) {
  ...
  if ((($a = (typeof(Opal.global.console) !== "undefined")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
...
Opal.modules["virtual_dom/virtual_node"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.name = def.params = def.children = nil;
      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(name, params, children) {
        var self = this;
      ...
      Opal.defn(self, '$to_s', TMP_3 = function ːto_s() {
        var $a, $b, self = this;

        return "<" + (self.name) + (self.$to_s_params()) + ">" + (($a = ($b = self.children).$map, $a.$$p = "to_s".$to_proc(), $a).call($b).$join()) + "</" + (self.name) + ">";
      }, TMP_3.$$arity = 0);

      return (Opal.defn(self, '$to_s_params', TMP_5 = function ːto_s_params() {
        var $a, $b, TMP_4, self = this;

        if ((($a = self.params['$any?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          return nil
        };
        return $rb_plus(" ", ($a = ($b = self.params).$map, $a.$$p = (TMP_4 = function(k, v){var self = TMP_4.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
        return "" + (k) + "=\"" + (v) + "\""}, TMP_4.$$s = self, TMP_4.$$arity = 2, TMP_4), $a).call($b).$join(" "));
      }, TMP_5.$$arity = 0), nil) && 'to_s_params';
    })($scope.base, null)
  })($scope.base)
};
/* Generated by Opal 0.10.1 */
Opal.modules["virtual_dom/wrapper"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      Opal.defn(self, '$create', TMP_1 = function ːcreate(vnode) {
        var self = this;

        return virtualDom.create(vnode);
      }, TMP_1.$$arity = 1);

      Opal.defn(self, '$diff', TMP_2 = function ːdiff(old, new$) {
        var self = this;

        return virtualDom.diff(old, new$);
      }, TMP_2.$$arity = 2);

      Opal.defn(self, '$patch', TMP_3 = function ːpatch(dom, diff) {
        var self = this;
...
Opal.modules["virtual_dom/dom"] = function(Opal) {
  ...
  Opal.add_stubs(['$each', '$define_method', '$call', '$to_n', '$new', '$process_params', '$==', '$count', '$<<', '$is_a?', '$===', '$[]=', '$delete', '$event_callback', '$dup', '$proc', '$wrap_event', '$to_s']);
  return (function($base) {
    var $VirtualDOM, self = $VirtualDOM = $module($base, 'VirtualDOM');
    ...
    (function($base) {
      ...
      var def = self.$$proto, $scope = self.$$scope, $a, $b, TMP_1, TMP_4, TMP_6, TMP_7, TMP_8;
      ...
      ($a = ($b = $scope.get('HTML_TAGS')).$each, $a.$$p = (TMP_1 = function(tag){var self = TMP_1.$$s || this, $c, $d, TMP_2;
if (tag == null) tag = nil;
      return ($c = ($d = self).$define_method, $c.$$p = (TMP_2 = function(params){var self = TMP_2.$$s || this, block, $e, current = nil, result = nil, vnode = nil;
        ...
        ((($e = self.__virtual_nodes__) !== false && $e !== nil && $e != null) ? $e : self.__virtual_nodes__ = []);
          if (block !== false && block !== nil && block != null) {
            current = self.__virtual_nodes__;
            self.__virtual_nodes__ = [];
            result = ((($e = block.$call()) !== false && $e !== nil && $e != null) ? $e : "");
          ...
          return vnode;}, TMP_2.$$s = self, TMP_2.$$arity = -1, TMP_2), $c).call($d, tag)}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b);

      Opal.defn(self, '$process_params', TMP_4 = function ːprocess_params(params) {
        var $a, $b, TMP_3, self = this;

        if ((($a = params['$is_a?']($scope.get('Hash'))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          return $hash2([], {})
        };
        ($a = ($b = params.$dup()).$each, $a.$$p = (TMP_3 = function(k, v){var self = TMP_3.$$s || this, $case = nil;
if (k == null) k = nil;if (v == null) v = nil;
        return (function() {$case = k;if ("class"['$===']($case)) {return params['$[]=']("className", params.$delete("class"))}else if ("data"['$===']($case)) {return params['$[]=']("dataset", params.$delete("data"))}else if ("default"['$===']($case)) {return params['$[]=']("defaultValue", params.$delete("default"))}else if (/^on/['$===']($case)) {return params['$[]='](k, self.$event_callback(v))}else { return nil }})()}, TMP_3.$$s = self, TMP_3.$$arity = 2, TMP_3), $a).call($b);
        return params;
      }, TMP_4.$$arity = 1);

      Opal.defn(self, '$event_callback', TMP_6 = function ːevent_callback(v) {
        var $a, $b, TMP_5, self = this;

        return ($a = ($b = self).$proc, $a.$$p = (TMP_5 = function(e){var self = TMP_5.$$s || this;
if (e == null) e = nil;
        return v.$call($scope.get('Support').$wrap_event(e))}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5), $a).call($b);
      }, TMP_6.$$arity = 1);

      Opal.defn(self, '$text', TMP_7 = function ːtext(string) {
        var self = this;
        if (self.__virtual_nodes__ == null) self.__virtual_nodes__ = nil;
      ...
      Opal.defn(self, '$virtual_dom', TMP_8 = function ːvirtual_dom() {
        var self = this, $iter = TMP_8.$$p, block = $iter || nil;
...
/* Generated by Opal 0.10.1 */
Opal.modules["virtual_dom/hook"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      function $CommonHook(){};
      var self = $CommonHook = $klass($base, $super, 'CommonHook', $CommonHook);

      var def = self.$$proto, $scope = self.$$scope, TMP_2, TMP_3, TMP_4, TMP_5;

      def.block = nil;
      Opal.defs(self, '$method', TMP_2 = function ːmethod(mthd) {
        var $a, $b, TMP_1, self = this;

        return ($a = ($b = self).$new, $a.$$p = (TMP_1 = function(node, name, previous){var self = TMP_1.$$s || this;
if (node == null) node = nil;if (name == null) name = nil;if (previous == null) previous = nil;
        return mthd.$call(node, name, previous)}, TMP_1.$$s = self, TMP_1.$$arity = 3, TMP_1), $a).call($b);
      }, TMP_2.$$arity = 1);
      ...
      Opal.defn(self, '$to_n', TMP_4 = function ːto_n() {
        var self = this;

        return self;
      }, TMP_4.$$arity = 0);

      return (Opal.defn(self, '$call_block', TMP_5 = function ːcall_block(node, name, previous) {
        var self = this;

        node = $scope.get('Support').$wrap_node(node);
        name = self.$Native(name);
        previous = self.$Native(previous);
        return self.block.$call(node, name, previous);
      }, TMP_5.$$arity = 3), nil) && 'call_block';
    })($scope.base, null);
    ...
    })($scope.base, $scope.get('CommonHook'));

    (function($base, $super) {
      function $UnHook(){};
      var self = $UnHook = $klass($base, $super, 'UnHook', $UnHook);
...
/* Generated by Opal 0.10.1 */
Opal.modules["virtual_dom/support"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;
  ...
  return (function($base) {
    ...
    (function($base) {
      var $Support, self = $Support = $module($base, 'Support');

      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2;

      self.$module_function();

      Opal.defn(self, '$wrap_node', TMP_1 = function ːwrap_node(node) {
        var self = this;

        return self.$Native(node);
      }, TMP_1.$$arity = 1);

      Opal.defn(self, '$wrap_event', TMP_2 = function ːwrap_event(event) {
        var self = this;
...
/* Generated by Opal 0.10.1 */
Opal.modules["inesita/browser"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module, $hash2 = Opal.hash2;

  Opal.add_stubs(['$module_function', '$global', '$Native', '$call', '$decodeURIComponent', '$native?', '$to_n']);
  return (function($base) {
    ...
    (function($base) {
      ...
      var def = self.$$proto, $scope = self.$$scope, $a, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_6, TMP_7, TMP_8, TMP_9, TMP_10, TMP_11, TMP_12;

      self.$module_function();

      Opal.cdecl($scope, 'Window', $scope.get('JS').$global());

      Opal.cdecl($scope, 'Document', $scope.get('Window')["document"]);

      Opal.cdecl($scope, 'Location', $scope.get('Document')["location"]);

      Opal.cdecl($scope, 'History', $scope.get('Window')["history"]);

      Opal.cdecl($scope, 'AddEventListener', $scope.get('Window')["addEventListener"]);

      if ((($a = self.$Native($scope.get('Window')["requestAnimationFrame"])) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        Opal.defn(self, '$animation_frame', TMP_1 = function ːanimation_frame() {
          var self = this, $iter = TMP_1.$$p, block = $iter || nil;

          TMP_1.$$p = null;
          return $scope.get('Window').requestAnimationFrame(block);
        }, TMP_1.$$arity = 0)
        } else {
        Opal.defn(self, '$animation_frame', TMP_2 = function ːanimation_frame() {
          var self = this, $iter = TMP_2.$$p, block = $iter || nil;
      ...
      Opal.defn(self, '$path', TMP_3 = function ːpath() {
        var self = this;

        return $scope.get('Location')["pathname"];
      }, TMP_3.$$arity = 0);

      Opal.defn(self, '$query', TMP_4 = function ːquery() {
        var self = this;

        return $scope.get('Location')["search"];
      }, TMP_4.$$arity = 0);

      Opal.defn(self, '$decode_uri_component', TMP_5 = function ːdecode_uri_component(value) {
        var self = this;

        return $scope.get('JS').$decodeURIComponent(value);
      }, TMP_5.$$arity = 1);

      Opal.defn(self, '$push_state', TMP_6 = function ːpush_state(path) {
        var self = this;

        return $scope.get('History').pushState($hash2([], {}), nil, path);
      }, TMP_6.$$arity = 1);

      Opal.defn(self, '$onpopstate', TMP_7 = function ːonpopstate() {
        var self = this, $iter = TMP_7.$$p, block = $iter || nil;

        TMP_7.$$p = null;
        return $scope.get('Window')["onpopstate"]=block;
      }, TMP_7.$$arity = 0);

      Opal.defn(self, '$hashchange', TMP_8 = function ːhashchange() {
        var self = this, $iter = TMP_8.$$p, block = $iter || nil;

        TMP_8.$$p = null;
        return $scope.get('AddEventListener').$call("hashchange", block);
      }, TMP_8.$$arity = 0);

      Opal.defn(self, '$ready?', TMP_9 = function() {
        var self = this, $iter = TMP_9.$$p, block = $iter || nil;

        TMP_9.$$p = null;
        return $scope.get('AddEventListener').$call("load", block);
      }, TMP_9.$$arity = 0);

      Opal.defn(self, '$body', TMP_10 = function ːbody() {
        var self = this;

        return $scope.get('Document')["body"];
      }, TMP_10.$$arity = 0);

      Opal.defn(self, '$append_child', TMP_11 = function ːappend_child(node, new_node) {
        var $a, self = this;
        ...
        if ((($a = self['$native?'](new_node)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
      ...
      Opal.defn(self, '$query_element', TMP_12 = function ːquery_element(css) {
        var self = this;

        return $scope.get('Document').querySelector(css);
      }, TMP_12.$$arity = 1);
    })($scope.base)
  })($scope.base)
};
...
Opal.modules["inesita/component_virtual_dom_extension"] = function(Opal) {
  ...
  Opal.add_stubs(['$alias_method', '$define_method', '$[]', '$merge', '$lambda', '$go_to', '$__a', '$to_proc', '$nil?', '$raise', '$class', '$<<', '$render_virtual_dom', '$with_props', '$cache_component', '$with_store', '$with_router', '$with_root_component', '$is_a?', '$new', '$init']);
  return (function($base) {
    var $Inesita, self = $Inesita = $module($base, 'Inesita');
    ...
    (function($base) {
      ...
      Opal.defs(self, '$included', TMP_3 = function ːincluded(base) {
        var $a, $b, TMP_1, self = this;

        base.$alias_method("__a", "a");
        return ($a = ($b = base).$define_method, $a.$$p = (TMP_1 = function(params){var self = TMP_1.$$s || this, block, $c, $d, TMP_2, $e;
          if (self.router == null) self.router = nil;

          block = TMP_1.$$p || nil, TMP_1.$$p = null;if (params == null) params = nil;
        if ((($c = ($d = params['$[]']("href"), $d !== false && $d !== nil && $d != null ?self.router : $d)) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            params = $hash2(["onclick"], {"onclick": ($c = ($d = self).$lambda, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
              if (self.router == null) self.router = nil;

            return self.router.$go_to(params['$[]']("href"))}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d)}).$merge(params)};
          return ($c = ($e = self).$__a, $c.$$p = block.$to_proc(), $c).call($e, params);}, TMP_1.$$s = self, TMP_1.$$arity = 1, TMP_1), $a).call($b, "a");
      }, TMP_3.$$arity = 1);

      Opal.defn(self, '$component', TMP_5 = function ːcomponent(comp, opts) {
        var $a, $b, TMP_4, self = this;
        if (self.__virtual_nodes__ == null) self.__virtual_nodes__ = nil;
        ...
        if ((($a = comp['$nil?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('Error'), "Component is nil in " + (self.$class()) + " class")};
        ((($a = self.__virtual_nodes__) !== false && $a !== nil && $a != null) ? $a : self.__virtual_nodes__ = []);
        return self.__virtual_nodes__['$<<'](($a = ($b = self).$cache_component, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this, $c;
          if (self.root_component == null) self.root_component = nil;
          if (self.router == null) self.router = nil;
          if (self.store == null) self.store = nil;

        comp = ((function() {if ((($c = comp['$is_a?']($scope.get('Class'))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            return comp.$new()
            } else {
            return comp
          }; return nil; })()).$with_root_component(self.root_component).$with_router(self.router).$with_store(self.store);
          comp.$init();
          return comp;}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $a).call($b, comp).$with_props(((($a = opts['$[]']("props")) !== false && $a !== nil && $a != null) ? $a : $hash2([], {}))).$render_virtual_dom());
      }, TMP_5.$$arity = -2);
    })($scope.base)
  })($scope.base)
};
...
Opal.modules["inesita/component_properties"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      Opal.defn(self, '$with_root_component', TMP_1 = function ːwith_root_component(component) {
        var self = this;
      ...
      Opal.defn(self, '$with_router', TMP_2 = function ːwith_router(router) {
        var self = this;
      ...
      Opal.defn(self, '$with_store', TMP_3 = function ːwith_store(store) {
        var self = this;
      ...
      Opal.defn(self, '$with_props', TMP_4 = function ːwith_props(props) {
        var self = this;
...
/* Generated by Opal 0.10.1 */
Opal.modules["inesita/component_helpers"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $module = Opal.module;

  Opal.add_stubs(['$each', '$<<', '$join']);
  return (function($base) {
    var $Inesita, self = $Inesita = $module($base, 'Inesita');
    ...
    (function($base) {
      var $ComponentHelpers, self = $ComponentHelpers = $module($base, 'ComponentHelpers');

      var def = self.$$proto, $scope = self.$$scope, TMP_2;

      Opal.defn(self, '$class_names', TMP_2 = function ːclass_names(hash) {
        var $a, $b, TMP_1, self = this, class_names = nil;

        class_names = [];
        ($a = ($b = hash).$each, $a.$$p = (TMP_1 = function(key, value){var self = TMP_1.$$s || this;
...
Opal.modules["inesita/component"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$raise', '$class', '$render_virtual_dom', '$create', '$append_child', '$diff', '$patch', '$render', '$one?', '$first', '$to_n', '$new', '$animation_frame', '$render_if_root', '$+', '$[]', '$[]=', '$call', '$method']);
  return (function($base) {
    var $Inesita, self = $Inesita = $module($base, 'Inesita');
    ...
    (function($base) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_2, TMP_3, TMP_4, TMP_5, TMP_7, TMP_8, TMP_9, TMP_10;

      self.$include((($scope.get('VirtualDOM')).$$scope.get('DOM')));

      self.$include($scope.get('ComponentHelpers'));
      ...
      Opal.defn(self, '$render', TMP_2 = function ːrender() {
        ...
        return self.$raise($scope.get('Error'), "Implement #render in " + (self.$class()) + " component");
      }, TMP_2.$$arity = 0);

      Opal.defn(self, '$mount_to', TMP_3 = function ːmount_to(element) {
        var self = this;
        if (self.virtual_dom == null) self.virtual_dom = nil;
        if (self.root_node == null) self.root_node = nil;

        if (element !== false && element !== nil && element != null) {
          } else {
          self.$raise($scope.get('Error'), "Can't mount " + (self.$class()) + ", target element not found!")
        };
        ...
        $scope.get('Browser').$append_child(element, self.root_node);
        return self;
      }, TMP_3.$$arity = 1);

      Opal.defn(self, '$render_if_root', TMP_4 = function ːrender_if_root() {
        var $a, $b, self = this, new_virtual_dom = nil, diff = nil;
        if (self.virtual_dom == null) self.virtual_dom = nil;
        if (self.root_node == null) self.root_node = nil;

        if ((($a = ($b = self.virtual_dom, $b !== false && $b !== nil && $b != null ?self.root_node : $b)) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          return nil
        };
      ...
      Opal.defn(self, '$render_virtual_dom', TMP_5 = function ːrender_virtual_dom() {
        var $a, self = this;
        if (self.__virtual_nodes__ == null) self.__virtual_nodes__ = nil;
        ...
        self.__virtual_nodes__ = [];
        self.$render();
        if ((($a = self.__virtual_nodes__['$one?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$render!', TMP_7 = function() {
        var $a, $b, TMP_6, self = this;

        return ($a = ($b = $scope.get('Browser')).$animation_frame, $a.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $c;
          if (self.root_component == null) self.root_component = nil;

        if ((($c = self.root_component) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            return self.root_component.$render_if_root()
            } else {
            return nil
          }}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $a).call($b);
      }, TMP_7.$$arity = 0);

      Opal.defn(self, '$cache_component', TMP_8 = function ːcache_component(component) {
        ...
        TMP_8.$$p = null;
        ((($a = self.cache_component) !== false && $a !== nil && $a != null) ? $a : self.cache_component = $hash2([], {}));
        ((($a = self.cache_component_counter) !== false && $a !== nil && $a != null) ? $a : self.cache_component_counter = 0);
        self.cache_component_counter = $rb_plus(self.cache_component_counter, 1);
        return ((($a = self.cache_component['$[]']("" + (component) + "-" + (self.cache_component_counter))) !== false && $a !== nil && $a != null) ? $a : self.cache_component['$[]=']("" + (component) + "-" + (self.cache_component_counter), block.$call()));
      }, TMP_8.$$arity = 1);

      Opal.defn(self, '$hook', TMP_9 = function ːhook(mthd) {
        var self = this;

        return (($scope.get('VirtualDOM')).$$scope.get('Hook')).$method(self.$method(mthd));
      }, TMP_9.$$arity = 1);

      Opal.defn(self, '$unhook', TMP_10 = function ːunhook(mthd) {
        var self = this;

        return (($scope.get('VirtualDOM')).$$scope.get('UnHook')).$method(self.$method(mthd));
      }, TMP_10.$$arity = 1);
    })($scope.base)
  })($scope.base)
};
...
Opal.modules["inesita/routes"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(parent) {
        var self = this;
      ...
      Opal.defn(self, '$route', TMP_2 = function ːroute($a_rest) {
        var $b, $c, self = this, params, $iter = TMP_2.$$p, block = $iter || nil, path = nil;
        ...
        path = (function() {if ((($b = self.parent) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
          return "" + (self.parent) + "/" + (path)
          } else {
          return "/" + (path)
        }; return nil; })();
        if ((block !== nil)) {
          ($b = ($c = self).$add_subroutes, $b.$$p = block.$to_proc(), $b).call($c, path)};
        if ((($b = params.$last()['$[]']("redirect_to")) !== nil && $b != null && (!$b.$$is_boolean || $b == true))) {
          return self.$add_redirect(path, params.$last()['$[]']("redirect_to"))
          } else {
          return self.$add_route(params.$last()['$[]']("as"), path, params.$last()['$[]']("to"), params.$last()['$[]']("props"))
        };
      }, TMP_2.$$arity = -1);

      Opal.defn(self, '$validate_component', TMP_3 = function ːvalidate_component(component) {
        var $a, self = this;

        if (component !== false && component !== nil && component != null) {
          } else {
          self.$raise($scope.get('Error'), "Component not exists")
        };
        if ((($a = component['$include?']((($scope.get('Inesita')).$$scope.get('Component')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return nil
          } else {
          return self.$raise($scope.get('Error'), "Invalid " + (component) + " class, should mixin Inesita::Component")
        };
      }, TMP_3.$$arity = 1);

      Opal.defn(self, '$add_redirect', TMP_4 = function ːadd_redirect(path, redirect_to) {
        var self = this;

        return self.routes['$<<']($hash2(["path", "redirect_to"], {"path": path, "redirect_to": redirect_to}).$merge(self.$build_params_and_regex(path)));
      }, TMP_4.$$arity = 2);

      Opal.defn(self, '$add_route', TMP_5 = function ːadd_route(name, path, component, component_props) {
        var $a, self = this;

        self.$validate_component(component);
        return self.routes['$<<']($hash2(["path", "component", "component_props", "name"], {"path": path, "component": component, "component_props": component_props, "name": ((($a = name) !== false && $a !== nil && $a != null) ? $a : component.$to_s().$gsub(/(.)([A-Z])/, "\\1_\\2").$downcase())}).$merge(self.$build_params_and_regex(path)));
      }, TMP_5.$$arity = 4);

      Opal.defn(self, '$add_subroutes', TMP_6 = function ːadd_subroutes(path) {
        var $a, $b, self = this, $iter = TMP_6.$$p, block = $iter || nil, subroutes = nil;
      ...
      return (Opal.defn(self, '$build_params_and_regex', TMP_8 = function ːbuild_params_and_regex(path) {
        var $a, $b, TMP_7, self = this, regex = nil, params = nil, parts = nil;
        ...
        if ((($a = parts['$empty?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          regex['$<<']("\\/")};
        (function(){var $brk = Opal.new_brk(); try {return ($a = ($b = parts).$each, $a.$$p = (TMP_7 = function(part){var self = TMP_7.$$s || this, $c, $case = nil;
if (part == null) part = nil;
        if ((($c = part['$empty?']()) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            return nil;};
          regex['$<<']("\\/");
          return (function() {$case = part['$[]'](0);if (":"['$===']($case)) {params['$<<'](part['$[]']($range(1, -1, false)));
          return regex['$<<']("([^\\/]+)");}else if ("*"['$===']($case)) {params['$<<'](part['$[]']($range(1, -1, false)));
          regex['$<<']("(.*)");
          
          Opal.brk(nil, $brk);}else {return regex['$<<'](part)}})();}, TMP_7.$$s = self, TMP_7.$$brk = $brk, TMP_7.$$arity = 1, TMP_7), $a).call($b)
        } catch (err) { if (err === $brk) { return err.$v } else { throw err } }})();
        regex['$<<']("$");
        return $hash2(["regex", "params"], {"regex": $scope.get('Regexp').$new(regex.$join()), "params": params});
      }, TMP_8.$$arity = 1), nil) && 'build_params_and_regex';
    })($scope.base, null)
  })($scope.base)
};
/* Generated by Opal 0.10.1 */
Opal.modules["inesita/router"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      var def = self.$$proto, $scope = self.$$scope, TMP_1, TMP_4, TMP_5, TMP_7, TMP_8, TMP_9, TMP_10, TMP_12, TMP_13, TMP_15, TMP_16, TMP_17, TMP_18, TMP_20;
      ...
      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize() {
        ...
        if ((($a = self['$respond_to?']("routes")) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          self.$raise($scope.get('Error'), "Add #routes method to router!")
        };
        self.$routes();
        if ((($a = self.routes.$routes()['$empty?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          self.$raise($scope.get('Error'), "Add #route to your #routes method!")};
        self.$find_route();
        self.$parse_url_params();
        return self.$add_listeners();
      }, TMP_1.$$arity = 0);

      Opal.defn(self, '$add_listeners', TMP_4 = function ːadd_listeners() {
        var $a, $b, TMP_2, $c, TMP_3, self = this;

        ($a = ($b = $scope.get('Browser')).$onpopstate, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;

        self.$find_route();
          self.$parse_url_params();
          return self['$render!']();}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $a).call($b);
        return ($a = ($c = $scope.get('Browser')).$hashchange, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;

        self.$find_route();
          self.$parse_url_params();
          return self['$render!']();}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $a).call($c);
      }, TMP_4.$$arity = 0);

      Opal.defn(self, '$route', TMP_5 = function ːroute($a_rest) {
        var $b, $c, self = this, params, $iter = TMP_5.$$p, block = $iter || nil;
        if (self.routes == null) self.routes = nil;
        ...
        TMP_5.$$p = null;
        return ($b = ($c = self.routes).$route, $b.$$p = block.$to_proc(), $b).apply($c, Opal.to_a(params));
      }, TMP_5.$$arity = -1);

      Opal.defn(self, '$find_route', TMP_7 = function ːfind_route() {try {

        var $a, $b, TMP_6, self = this;
        if (self.routes == null) self.routes = nil;

        ($a = ($b = self.routes.$routes()).$each, $a.$$p = (TMP_6 = function(route){var self = TMP_6.$$s || this, $c;
if (route == null) route = nil;
        if ((($c = self.$path().$match(route['$[]']("regex"))) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            } else {
            return nil;
          };
          if ((($c = route['$[]']("redirect_to")) !== nil && $c != null && (!$c.$$is_boolean || $c == true))) {
            Opal.ret(self.$go_to(self.$url_for(route['$[]']("redirect_to"))))};
          Opal.ret(self.route = route);}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6), $a).call($b);
        return self.$raise($scope.get('Error'), "Can't find route for url");
        } catch ($returner) { if ($returner === Opal.returner) { return $returner.$v } throw $returner; }
      }, TMP_7.$$arity = 0);

      Opal.defn(self, '$find_component', TMP_8 = function ːfind_component(route) {
        var self = this;
      ...
      Opal.defn(self, '$render', TMP_9 = function ːrender() {
        ...
        if ((($a = self.route) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$go_to', TMP_10 = function ːgo_to(path) {
        var self = this;

        $scope.get('Browser').$push_state(path);
        self.$find_route();
        self.$parse_url_params();
        self['$render!']();
        return false;
      ...
      Opal.defn(self, '$parse_url_params', TMP_12 = function ːparse_url_params() {
        var $a, $b, TMP_11, self = this;

        self.params = self.$compotent_url_params();
        if ((($a = self.$query()['$empty?']()) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return nil
          } else {
          return ($a = ($b = self.$query()['$[]']($range(1, -1, false)).$split("&")).$each, $a.$$p = (TMP_11 = function(param){var self = TMP_11.$$s || this, $c, $d, key = nil, value = nil;
            if (self.params == null) self.params = nil;
if (param == null) param = nil;
          $d = param.$split("="), $c = Opal.to_ary($d), key = ($c[0] == null ? nil : $c[0]), value = ($c[1] == null ? nil : $c[1]), $d;
            return self.params['$[]=']($scope.get('Browser').$decode_uri_component(key), $scope.get('Browser').$decode_uri_component(value));}, TMP_11.$$s = self, TMP_11.$$arity = 1, TMP_11), $a).call($b)
        };
      }, TMP_12.$$arity = 0);

      Opal.defn(self, '$compotent_url_params', TMP_13 = function ːcompotent_url_params() {
        var self = this;
        if (self.route == null) self.route = nil;

        return $scope.get('Hash')['$[]'](self.route['$[]']("params").$zip(self.$path().$match(self.route['$[]']("regex"))['$[]']($range(1, -1, false))));
      }, TMP_13.$$arity = 0);

      Opal.defn(self, '$url_for', TMP_15 = function ːurl_for(name, params) {
        var $a, $b, TMP_14, self = this, route = nil;
        if (self.routes == null) self.routes = nil;

        if (params == null) {
          params = nil;
        }
        route = ($a = ($b = self.routes.$routes()).$find, $a.$$p = (TMP_14 = function(r){var self = TMP_14.$$s || this, $c, $case = nil;
if (r == null) r = nil;
        return (function() {$case = name;if ($scope.get('String')['$===']($case)) {return ((($c = r['$[]']("name")['$=='](name)) !== false && $c !== nil && $c != null) ? $c : r['$[]']("path")['$=='](name))}else if ($scope.get('Object')['$===']($case)) {return r['$[]']("component")['$=='](name)}else {return false}})()}, TMP_14.$$s = self, TMP_14.$$arity = 1, TMP_14), $a).call($b);
        if (route !== false && route !== nil && route != null) {
          return self.$url_with_params(route, params)
          } else {
          return self.$raise($scope.get('Error'), "Route '" + (name) + "' not found.")
        };
      }, TMP_15.$$arity = -2);

      Opal.defn(self, '$query', TMP_16 = function ːquery() {
        var self = this;

        return $scope.get('Browser').$query();
      }, TMP_16.$$arity = 0);

      Opal.defn(self, '$path', TMP_17 = function ːpath() {
        var self = this;

        return $scope.get('Browser').$path();
      }, TMP_17.$$arity = 0);

      Opal.defn(self, '$current_url?', TMP_18 = function(name) {
        var self = this;

        return self.$path()['$=='](self.$url_for(name, self.$params()));
      }, TMP_18.$$arity = 1);

      Opal.defn(self, '$url_with_params', TMP_20 = function ːurl_with_params(route, params) {
        var $a, $b, TMP_19, self = this, path = nil;

        path = route['$[]']("path");
        if (params !== false && params !== nil && params != null) {
          ($a = ($b = params).$each, $a.$$p = (TMP_19 = function(key, value){var self = TMP_19.$$s || this;
if (key == null) key = nil;if (value == null) value = nil;
          return path = path.$gsub(":" + (key), "" + (value))}, TMP_19.$$s = self, TMP_19.$$arity = 2, TMP_19), $a).call($b)};
        return path;
      }, TMP_20.$$arity = 2);
    })($scope.base)
  })($scope.base)
...
Opal.modules["inesita/store"] = function(Opal) {
  ...
  Opal.add_stubs(['$render!', '$root_component', '$attr_reader']);
  return (function($base) {
    var $Inesita, self = $Inesita = $module($base, 'Inesita');
    ...
    (function($base) {
      ...
      Opal.defn(self, '$store', TMP_2 = function ːstore() {
        var self = this;

        return self;
      }, TMP_2.$$arity = 0);

      Opal.defn(self, '$render!', TMP_3 = function() {
        var self = this;
      ...
      Opal.defn(self, '$with_root_component', TMP_4 = function ːwith_root_component(component) {
        var self = this;
      ...
      Opal.defn(self, '$with_router', TMP_5 = function ːwith_router(router) {
        var self = this;
...
Opal.modules["inesita/application"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$setup_router', '$[]', '$setup_layout', '$setup_root', '$setup_store', '$component', '$private', '$include?', '$raise', '$new', '$define_method', '$store', '$with_router', '$with_root_component', '$init']);
  return (function($base) {
    var $Inesita, self = $Inesita = $module($base, 'Inesita');
    ...
    (function($base, $super) {
      ...
      def.root = def.layout = def.router = def.store = nil;
      self.$include((($scope.get('Inesita')).$$scope.get('Component')));

      Opal.defn(self, '$initialize', TMP_1 = function ːinitialize(options) {
        var self = this;
      ...
      Opal.defn(self, '$setup_router', TMP_5 = function ːsetup_router(router) {
        var $a, $b, TMP_3, self = this;

        if (router !== false && router !== nil && router != null) {
          if ((($a = router['$include?']((($scope.get('Inesita')).$$scope.get('Router')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            } else {
            self.$raise($scope.get('Error'), "Invalid " + (router) + " class, should mixin Inesita::Router")
          };
          return self.router = router.$new();
          } else {
          return self.router = ($a = ($b = $scope.get('Class')).$new, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $c, $d, TMP_4;

          return ($c = ($d = self).$define_method, $c.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;

            return self.$raise("Router missing")}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $c).call($d, "method_missing")}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $a).call($b).$new()
        };
      }, TMP_5.$$arity = 1);

      Opal.defn(self, '$setup_layout', TMP_6 = function ːsetup_layout(layout) {
        var $a, self = this;

        if (layout !== false && layout !== nil && layout != null) {
          if ((($a = layout['$include?']((($scope.get('Inesita')).$$scope.get('Layout')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
            } else {
            self.$raise($scope.get('Error'), "Invalid " + (layout) + " class, should mixin Inesita::Layout")
          };
      ...
      Opal.defn(self, '$setup_root', TMP_7 = function ːsetup_root() {
        var $a, self = this;

        if ((($a = self.layout) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return self.root = self.layout
        } else if ((($a = self.router) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          return self.root = self.router
          } else {
          return self.$raise($scope.get('Error'), "Router or Layout not found!")
        };
      }, TMP_7.$$arity = 0);

      return (Opal.defn(self, '$setup_store', TMP_8 = function ːsetup_store(store) {
        var $a, self = this;

        if (store !== false && store !== nil && store != null) {
          } else {
          return nil
        };
        if ((($a = store['$include?']((($scope.get('Inesita')).$$scope.get('Store')))) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
          } else {
          self.$raise($scope.get('Error'), "Invalid " + (store) + " class, should mixin Inesita::Store")
        };
        self.store = store.$new().$with_root_component(self.root).$with_router(self.router).$store();
        return self.store.$init();
      }, TMP_8.$$arity = 1), nil) && 'setup_store';
    })($scope.base, null)
  })($scope.base)
};
/* Generated by Opal 0.10.1 */
Opal.modules["inesita/layout"] = function(Opal) {
  ...
  return (function($base) {
    ...
    (function($base) {
      ...
      Opal.defn(self, '$outlet', TMP_1 = function ːoutlet() {
        var self = this;
        if (self.router == null) self.router = nil;
...
Opal.modules["inesita"] = function(Opal) {
  ...
  self.$require("inesita/component_helpers");
...
/* Generated by Opal 0.10.1 */
Opal.modules["router"] = function(Opal) {
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2;
  ...
  return (function($base, $super) {
    ...
    self.$include((($scope.get('Inesita')).$$scope.get('Router')));

    return (Opal.defn(self, '$routes', TMP_1 = function ːroutes() {
      var self = this;

      return self.$route("/", $hash2(["to"], {"to": $scope.get('Home')}));
    }, TMP_1.$$arity = 0), nil) && 'routes';
  })($scope.base, null)
};
/* Generated by Opal 0.10.1 */
Opal.modules["store"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$to_n', '$each', '$set', '$to_i', '$[]=', '$[]']);
  return (function($base, $super) {
    function $Store(){};
    ...
    Opal.defn(self, '$initialize', TMP_2 = function ːinitialize() {
      var $a, $b, TMP_1, self = this, store = nil;

      self.store = $hash2(["batt-cells", "motor-kv", "system-efficiency", "out-battery-volts", "out-motor-rpm", "out-motor-rpm-weighted", "motor-pulley-teeth", "wheel-pulley-teeth", "wheel-size", "out-gear-ratio", "out-top-speed", "out-top-speed-weighted"], {"batt-cells": 10, "motor-kv": 200, "system-efficiency": 80, "out-battery-volts": 0, "out-motor-rpm": 0, "out-motor-rpm-weighted": 0, "motor-pulley-teeth": 15, "wheel-pulley-teeth": 36, "wheel-size": 83, "out-gear-ratio": "x", "out-top-speed": 0, "out-top-speed-weighted": 0});
      store = self.store.$to_n();
      if ((($a = localStorage.esk8_calc) !== nil && $a != null && (!$a.$$is_boolean || $a == true))) {
        return ($a = ($b = self.store).$each, $a.$$p = (TMP_1 = function(key, _){var self = TMP_1.$$s || this, val = nil;
if (key == null) key = nil;if (_ == null) _ = nil;
        val = localStorage["esk8_calc_"+key];
          return self.$set(key, val.$to_i());}, TMP_1.$$s = self, TMP_1.$$arity = 2, TMP_1), $a).call($b)
        } else {
        return nil
      };
    }, TMP_2.$$arity = 0);

    Opal.defn(self, '$set', TMP_3 = function ːset(key, value) {
      var self = this;

      return self.store['$[]='](key, value);
    }, TMP_3.$$arity = 2);

    Opal.defn(self, '$get', TMP_4 = function ːget(key) {
      var self = this;

      return self.store['$[]'](key);
    }, TMP_4.$$arity = 1);

    return (Opal.defn(self, '$save!', TMP_6 = function() {
      var $a, $b, TMP_5, self = this;

      ($a = ($b = self.store).$each, $a.$$p = (TMP_5 = function(key, val){var self = TMP_5.$$s || this;
if (key == null) key = nil;if (val == null) val = nil;
      return localStorage["esk8_calc_"+key] = val;}, TMP_5.$$s = self, TMP_5.$$arity = 2, TMP_5), $a).call($b);
      return localStorage.esk8_calc = true;
    }, TMP_6.$$arity = 0), nil) && 'save!';
  })($scope.base, null)
};
/* Generated by Opal 0.10.1 */
Opal.modules["layout"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$div', '$component', '$router']);
  return (function($base, $super) {
    function $Layout(){};
    ...
    return (Opal.defn(self, '$render', TMP_2 = function ːrender() {
      ...
      return ($a = ($b = self).$div, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

      return self.$component(self.$router())}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $hash2(["class"], {"class": "container"}));
    }, TMP_2.$$arity = 0), nil) && 'render';
  })($scope.base, null)
};
/* Generated by Opal 0.10.1 */
Opal.modules["calc"] = function(Opal) {
  function $rb_times(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs * rhs : lhs['$*'](rhs);
  }
  function $rb_divide(lhs, rhs) {
  ...
  Opal.add_stubs(['$get', '$round', '$*', '$set', '$/']);
  return (function($base, $super) {
    function $Calc(){};
    var self = $Calc = $klass($base, $super, 'Calc', $Calc);

    var def = self.$$proto, $scope = self.$$scope, TMP_1;

    Opal.cdecl($scope, 'LIPO_VOLTS', 3.7);

    Opal.cdecl($scope, 'R', 3.728226e-05);

    return (Opal.defs(self, '$calc!', TMP_1 = function(store) {
      var self = this, cell_volts = nil, batt_cells = nil, batt_volts = nil, motor_kv = nil, raw_efficiency = nil, efficiency = nil, motor_rpm = nil, motor_rpm_weighted = nil, motor_teeth = nil, wheel_teeth = nil, gear_ratio = nil, gear_ratio_out = nil, wheel_size = nil, top_speed_mph = nil, top_speed_kmh = nil, top_speed_mph_w = nil, top_speed_kmh_w = nil;

      cell_volts = $scope.get('LIPO_VOLTS');
      batt_cells = store.$get("batt-cells");
      batt_volts = ($rb_times(batt_cells, cell_volts)).$round(1);
      store.$set("out-battery-volts", batt_volts);
      motor_kv = store.$get("motor-kv");
      raw_efficiency = store.$get("system-efficiency");
      efficiency = $rb_divide(raw_efficiency, 100);
      motor_rpm = $rb_times(motor_kv, batt_volts);
      motor_rpm_weighted = $rb_times(motor_rpm, efficiency);
      ...
      top_speed_kmh = $rb_times(top_speed_mph, 1.609344);
      top_speed_mph_w = $rb_times(top_speed_mph, efficiency);
      top_speed_kmh_w = $rb_times(top_speed_kmh, efficiency);
      store.$set("out-top-speed", top_speed_mph);
      return store.$set("out-top-speed-weighted", top_speed_mph_w);
    }, TMP_1.$$arity = 1), nil) && 'calc!';
  })($scope.base, null)
};
/* Generated by Opal 0.10.1 */
Opal.modules["components/home"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$include', '$lambda', '$calc!', '$render!', '$to_n', '$name', '$target', '$value', '$set', '$to_i', '$save!', '$get', '$round', '$div', '$h1', '$text', '$p', '$section', '$form', '$label', '$select', '$option', '$input', '$method', '$label_gear_ratio', '$label_speed', '$button']);
  self.$require("calc");
  return (function($base, $super) {
    function $Home(){};
    ...
    Opal.defn(self, '$initialize', TMP_2 = function ːinitialize() {
      var $a, $b, TMP_1, self = this, block = nil;

      block = ($a = ($b = self).$lambda, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;
        if (self.store == null) self.store = nil;

      $scope.get('Calc')['$calc!'](self.store);
        return self['$render!']();}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
      return window.setTimeout(block.$to_n(), 1000);
    }, TMP_2.$$arity = 0);

    Opal.defn(self, '$change', TMP_3 = function ːchange(e) {
      var self = this, key = nil, val = nil;

      key = e.$target().$name();
      val = e.$target().$value();
      self.store.$set(key, val.$to_i());
      $scope.get('Calc')['$calc!'](self.store);
      return self['$render!']();
    }, TMP_3.$$arity = 1);

    Opal.defn(self, '$save', TMP_4 = function ːsave(e) {
      var self = this;

      return self.store['$save!']();
    }, TMP_4.$$arity = 1);

    Opal.defn(self, '$label_speed', TMP_5 = function ːlabel_speed($kwargs) {
      var self = this, weighted, speed = nil;
      ...
      if ((weighted = $kwargs.$$smap['weighted']) == null) {
        weighted = false
      }
      speed = self.store.$get("out-top-speed" + ((function() {if (weighted !== false && weighted !== nil && weighted != null) {
        return "-weighted"
        } else {
        return nil
      }; return nil; })()));
      return "" + (speed.$round(2)) + " km/h - x mph";
    }, TMP_5.$$arity = -1);

    Opal.defn(self, '$label_gear_ratio', TMP_6 = function ːlabel_gear_ratio() {
      var self = this;
        ...
        return ($g = ($h = self).$form, $g.$$p = (TMP_11 = function(){var self = TMP_11.$$s || this, $i, $j, TMP_12, $k, TMP_36, $l, TMP_37, $m, TMP_44, $n, TMP_47, $o, TMP_48, $p, TMP_51;
          ...
          ($i = ($j = self).$div, $i.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this, $k, $l, TMP_13, $m, TMP_14, $n, TMP_26;
            ...
            ($k = ($l = self).$h1, $k.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this;
              ...
              ($n = ($o = self).$div, $n.$$p = (TMP_15 = function(){var self = TMP_15.$$s || this, $p, $q, TMP_16, $r, TMP_17;
                ...
                ($p = ($q = self).$label, $p.$$p = (TMP_16 = function(){var self = TMP_16.$$s || this;
                  ...
                  ($s = ($t = self).$option, $s.$$p = (TMP_18 = function(){var self = TMP_18.$$s || this;
                    ...
                    return self.$text("Lipo")}, TMP_18.$$s = self, TMP_18.$$arity = 0, TMP_18), $s).call($t);
                    return ($s = ($u = self).$option, $s.$$p = (TMP_19 = function(){var self = TMP_19.$$s || this;

                    return self.$text("Li-ion")}, TMP_19.$$s = self, TMP_19.$$arity = 0, TMP_19), $s).call($u);}, TMP_17.$$s = self, TMP_17.$$arity = 0, TMP_17), $p).call($r, $hash2(["name", "id", "class"], {"name": "batt-type", "id": "batt-type", "class": "form-control"}));}, TMP_15.$$s = self, TMP_15.$$arity = 0, TMP_15), $n).call($o, $hash2(["class"], {"class": "form-group"}));
...
Opal.modules["components/navbar"] = function(Opal) {
  ...
  Opal.add_stubs(['$include', '$nav', '$div', '$span', '$text', '$ul', '$li', '$a', '$url_for', '$router', '$current_url?']);
  return (function($base, $super) {
    function $NavBar(){};
    ...
    return (Opal.defn(self, '$render', TMP_8 = function ːrender() {
      ...
      return ($a = ($b = self).$nav, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this, $c, $d, TMP_2;

      return ($c = ($d = self).$div, $c.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this, $e, $f, TMP_3;

        return ($e = ($f = self).$div, $e.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this, $g, $h, TMP_4, $i, TMP_5;

          ($g = ($h = self).$span, $g.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;

            return self.$text("Esk8 Calc")}, TMP_4.$$s = self, TMP_4.$$arity = 0, TMP_4), $g).call($h, $hash2(["class"], {"class": "navbar-brand"}));
            return ($g = ($i = self).$ul, $g.$$p = (TMP_5 = function(){var self = TMP_5.$$s || this, $j, $k, TMP_6, $l;

            return ($j = ($k = self).$li, $j.$$p = (TMP_6 = function(){var self = TMP_6.$$s || this, $l, $m, TMP_7;

              return ($l = ($m = self).$a, $l.$$p = (TMP_7 = function(){var self = TMP_7.$$s || this;

                return self.$text("Home")}, TMP_7.$$s = self, TMP_7.$$arity = 0, TMP_7), $l).call($m, $hash2(["href"], {"href": self.$router().$url_for("home")}))}, TMP_6.$$s = self, TMP_6.$$arity = 0, TMP_6), $j).call($k, $hash2(["class"], {"class": "" + ((function() {if ((($l = self.$router()['$current_url?']("home")) !== nil && $l != null && (!$l.$$is_boolean || $l == true))) {
                return "active"
                } else {
                return nil
              }; return nil; })())}))}, TMP_5.$$s = self, TMP_5.$$arity = 0, TMP_5), $g).call($i, $hash2(["class"], {"class": "nav navbar-nav"}));}, TMP_3.$$s = self, TMP_3.$$arity = 0, TMP_3), $e).call($f, $hash2(["class"], {"class": "navbar-header"}))}, TMP_2.$$s = self, TMP_2.$$arity = 0, TMP_2), $c).call($d, $hash2(["class"], {"class": "container"}))}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b, $hash2(["class"], {"class": "navbar navbar-default"}));
...
Opal.modules["application"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$require_tree', '$ready?', '$mount_to', '$new', '$body']);
  self.$require("inesita");
  self.$require("router");
  self.$require("store");
  self.$require("layout");
  self.$require_tree("components");
  return ($a = ($b = (($scope.get('Inesita')).$$scope.get('Browser')))['$ready?'], $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;

  return (($scope.get('Inesita')).$$scope.get('Application')).$new($hash2(["router", "store", "layout"], {"router": $scope.get('Router'), "store": $scope.get('Store'), "layout": $scope.get('Layout')})).$mount_to((($scope.get('Inesita')).$$scope.get('Browser')).$body())}, TMP_1.$$s = self, TMP_1.$$arity = 0, TMP_1), $a).call($b);
};

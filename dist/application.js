...
Opal.modules["store"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.defn(self, '$initialize', TMP_2 = function ːinitialize() {
      ...
      self.store = $hash2(["batt-type-lipo", "batt-cells", "motor-kv", "system-efficiency", "out-battery-volts", "out-motor-rpm", "out-motor-rpm-weighted", "motor-pulley-teeth", "wheel-pulley-teeth", "wheel-size", "out-gear-ratio", "out-top-speed", "out-top-speed-weighted"], {"batt-type-lipo": 1, "batt-cells": 10, "motor-kv": 200, "system-efficiency": 80, "out-battery-volts": 0, "out-motor-rpm": 0, "out-motor-rpm-weighted": 0, "motor-pulley-teeth": 15, "wheel-pulley-teeth": 36, "wheel-size": 83, "out-gear-ratio": "x", "out-top-speed": 0, "out-top-speed-weighted": 0});
...
Opal.modules["calc"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    Opal.cdecl($scope, 'LIIO_VOLTS', 3.6);

    Opal.cdecl($scope, 'R', 3.728226e-05);

    return (Opal.defs(self, '$calc!', TMP_1 = function(store) {
      var self = this, type_lipo = nil, cell_volts = nil, batt_cells = nil, batt_volts = nil, motor_kv = nil, raw_efficiency = nil, efficiency = nil, motor_rpm = nil, motor_rpm_weighted = nil, motor_teeth = nil, wheel_teeth = nil, gear_ratio = nil, gear_ratio_out = nil, wheel_size = nil, top_speed_mph = nil, top_speed_mph_w = nil;

      type_lipo = store.$get("batt-type-lipo");
      cell_volts = (function() {if (type_lipo['$=='](1)) {
        return $scope.get('LIPO_VOLTS')
        } else {
        return $scope.get('LIIO_VOLTS')
      }; return nil; })();
...
Opal.modules["components/home"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$include', '$lambda', '$calc!', '$render!', '$to_n', '$name', '$target', '$value', '$set', '$to_i', '$save!', '$get', '$*', '$round', '$div', '$h1', '$text', '$p', '$section', '$form', '$label', '$==', '$select', '$option', '$!', '$method', '$input', '$label_gear_ratio', '$label_speed', '$button']);
  self.$require("calc");
  return (function($base, $super) {
    function $Home(){};
    ...
    Opal.defn(self, '$label_speed', TMP_5 = function ːlabel_speed($kwargs) {
      var self = this, weighted, speed = nil, speed_kmh = nil;
      ...
      speed_kmh = $rb_times(speed, 1.609344);
      return "" + (speed.$round(2)) + " km/h - " + (speed_kmh.$round(2)) + " mph";
    }, TMP_5.$$arity = -1);
